// const names = ["Deborah", "Samuel", "Victor", "Boluwatife", "Mary", "Esther", "Joy", "Maria", "Mayen" ]
...
// const myName = ({name, age, houseAddress}) => {
//     console.log(`My name is ${name}, I am ${age} years old and I live at ${houseAddress}`)
// }

// myName({houseAddress:"94, Olorunkemi street, ", age:27, name:"Boluwatife"})
...
// const lastNamesWithB = students.filter((student) => {
//     return student.lastName.startsWith ("B")
// })
// console.log(lastNamesWithB)

// const lastNameWithB = students.find((student) =>{
//     return student.lastName.startsWith ("B")
// })
// console.log(lastNameWithB)

const isAgePresent = students.some((student) =>{
    return student.age === 19
})
console.log(isAgePresent)
